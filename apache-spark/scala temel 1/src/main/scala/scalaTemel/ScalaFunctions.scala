...
object ScalaFunctions {
  def main(args: Array[String]): Unit = {
    ...
    kendiniTanit("Selçuk", 26) // Sonuç: Benim adım: Nebi, yaşım: 33
    ...
    println("args ile sayilarin toplami: " + sayilariTopla(1,2,200,300))
    ...
    println("ikiSayiCarpimVeToplam " + ikiSayiCarpimVeToplam(50,30))
